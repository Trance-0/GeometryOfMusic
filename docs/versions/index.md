...
User-visible change log, one page per pre-0.1 round. Round entries
from the agent-facing log in `docs/LLM_CHECK.md` are summarized here
for humans.

| Version | Date | Highlights |
|---|---|---|
| [0.0.1](0.0.1.md) | 2026-04-20 | Prototype bootstrap — torus + timeline + synth + docs scaffolding. |
| [0.0.2](0.0.2.md) | 2026-04-20 | Axis fix, raycaster selection, three tracks, tour, theme, resize handle. |
...
| [0.0.7](0.0.7.md) | 2026-04-20 | Playhead moved from torus to a smooth red line on the timeline with drag-scrub; highlight glow now uses track color; cells colored per track. |
